#!/bin/sh
# Scyron's Auto Rice Boostrapping Script (SARBS)
# by Gabriel Marafon <marafongabriel@gmail.com>
# credits to Luke Smith for helping <luke@lukesmith.xyz>
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/scyron85/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/scyron85/SARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome." --msgbox "Welcome to SCYRON's OS Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Gabriel" 10 60
...
preinstallmsg() { \
	dialog --title " After this, there is no turning back. You take the blue pill—the story ends, you wake up in your bed and believe whatever you want to believe. You take the red pill and I show you how deep the rabbit hole goes!" --yes-label "(Take the red pill) Let's go!" --no-label "(Take the blue pill) Stay in wonderland." --yesno "The rest of the installation will now be totally automated, so you can sit back and relax.\\n\\nIt will take some time, but when done, you can relax even more with your out of the Matrix fresh system.\\n\\nNow just press <Go> and the system will begin installation!" 13 60 || { clear; exit 1; }
	}
...
finalize(){ \
	...
	dialog --title "You're done." --msgbox "Congrats! Provided there were no hidden errors, the script completed successfully and all the programs and configuration files should be in place.\\n\\nTo run the new graphical environment, log out and log back in as your new user, then run the command \"startx\" to start the graphical environment (it will start automatically in tty1).\\n\\n.t Gabriel" 12 80
	}
...
dialog --title "SARBS Installation" --infobox "Finally, installing \`libxft-bgra\` to enable color emoji in suckless software without crashes." 5 70
